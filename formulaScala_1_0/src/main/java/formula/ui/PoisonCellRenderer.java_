...
/**
 * 毒性レポートの毒性表(ptable)用レンダラ
 */
public class PoisonCellRenderer extends DefaultTableCellRenderer {
  private PoisonListM plm;
  /**
   * PoisonCellRenderer コンストラクター・コメント。
   */
  public PoisonCellRenderer(PoisonListM plm, int horizontalAlignment) {
    super();
    this.plm = plm;
